...
const About = () => {
  return (
    <section className='container flex mx-auto items-center justify-between mb-[12.5rem]'>
      ...
      <div className=''>
        <img className='w-[33.75rem] h-[36.75rem] rounded-lg' src={AboutImg} alt="home describtion image" />
      </div>
    </section>
  )
}
